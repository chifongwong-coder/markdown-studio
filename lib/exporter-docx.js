...
(function () {
  ...
  function buildDocumentRelsXml(ctx) {
    // Numbering is always present (rId2 is reserved for it), so list
    // <w:p> elements can reference numbering.xml unconditionally.
    let body = '<Relationship Id="rId2" Type="' + NUMBERING_REL + '" Target="numbering.xml"/>';
