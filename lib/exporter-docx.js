...
(function () {
  ...
  function buildTable(tableEl, ctx) {
    ...
    const tblPr =
      '<w:tblPr>' +
        // Explicit total width matching the gridCol sum. "auto" left Word
        // unsure how to lay out the table when gridCol widths were also
        // declared, occasionally producing collapsed-to-zero-height cells.
        ...
        '</w:tblBorders>' +
        // Use the declared gridCol widths instead of auto-shrink. Pairs
        // with the explicit tblW above so Word doesn't second-guess us.
