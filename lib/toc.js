...
(function () {
  ...
  function buildSidebar(items) {
    ...
    // Font picker: lets the reader switch the on-screen reading font. Built by
    // lib/fonts.js, which also persists the choice and applies it on load.
    if (window.MarkdownStudio && window.MarkdownStudio.buildFontPicker) {
      try {
        actions.appendChild(window.MarkdownStudio.buildFontPicker());
      } catch (e) {
        console.warn('[markdown-studio] font picker failed to mount:', e);
      }
    }
