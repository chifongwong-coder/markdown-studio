...
(function () {
  ...
  function buildSidebar(items) {
    ...
    printBtn.addEventListener('click', async () => {
      ...
      try {
        ...
        try { window.print(); }
          ...
          console.warn('[markdown-studio] print failed:', e);
          cleanup();
        }
      } finally {
    ...
    wordBtn.addEventListener('click', async () => {
      ...
      // scope doesn't see mountTOC's `article` parameter.
      const articleEl = document.body.querySelector('article.markdown-studio-content');
      if (!articleEl) {
